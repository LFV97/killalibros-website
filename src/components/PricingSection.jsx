...
export function PricingSection() {
  ...
  return (
    <section className="container my-4 text-center">
      <h2 className="text-light">{t("pricing.title")}</h2>
      <p className="text-light">{t("pricing.description")}</p>
      ...
      <p className="text-light mt-3">{t("pricing.request_quote")}</p>
      <ul className="text-light text-start mx-auto col-8">
...
//     </p>
//     <pre className="text-light text-start mx-auto col-8" style={{ overflow: "hidden" }}>
